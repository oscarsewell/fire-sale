"""Tests for the overclockers Lambda handler"""
import json
import pytest
...
def test_lambda_handler_filters_overclockers_products():
    """Test that lambda_handler only processes overclockers products."""
    mock_products_by_site = {
        "overclockers": [[1, "https://www.overclockers.co.uk/product/1"]],
    ...
    mock_scraped = [
        {
            "product_id": 1,
            "url": "https://www.overclockers.co.uk/product/1",
            "current_price": "£100",
            "currency_code": "GBP",
            "page_exists": True,
...
def test_lambda_handler_ignores_other_sites():
    """Test that lambda_handler ignores products from non-overclockers sites."""
    mock_products_by_site = {
...
def test_lambda_handler_empty_overclockers_site():
    """Test that lambda_handler handles empty overclockers product list."""
    mock_products_by_site = {
        "overclockers": [],
        "ebuyer": [[2, "https://www.ebuyer.com/product/2"]],
    }
...
def test_lambda_handler_missing_overclockers_site():
    """Test that lambda_handler handles missing overclockers site gracefully."""
    mock_products_by_site = {
        "awd-it": [[1, "https://www.awd-it.co.uk/product/1"]],
    }
...
def test_lambda_handler_multiple_overclockers_products():
    """Test that lambda_handler processes multiple overclockers products."""
    mock_products_by_site = {
        "overclockers": [
            [1, "https://www.overclockers.co.uk/product/1"],
            [2, "https://www.overclockers.co.uk/product/2"],
        ],
    }
    ...
    mock_scraped = [
        ...
        {
            "product_id": 2,
            "url": "https://www.overclockers.co.uk/product/2",
            "current_price": "£200",
            "currency_code": "GBP",
            "page_exists": True,
            "scraped_at": "2024-01-01T00:00:00"
