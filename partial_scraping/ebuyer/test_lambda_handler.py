"""Tests for the ebuyer Lambda handler."""
import json
import pytest
...
def test_lambda_handler_filters_ebuyer_products():
    """Test that lambda_handler only processes ebuyer products."""
    mock_products_by_site = {
        "ebuyer": [[1, "https://www.ebuyer.com/product/1"]],
        "overclockers": [[2, "https://www.overclockers.co.uk/product/2"]],
    }

    mock_scraped = [
        {
            "product_id": 1,
            "url": "https://www.ebuyer.com/product/1",
            "current_price": "$100",
            "currency_code": "USD",
            "page_exists": True,
    ...
    # Ensure overclockers wasn't processed
    assert "overclockers" not in json.dumps(body)


def test_lambda_handler_ignores_other_sites():
    """Test that lambda_handler ignores products from non-ebuyer sites."""
    mock_products_by_site = {
...
def test_lambda_handler_empty_ebuyer_site():
    """Test that lambda_handler handles empty ebuyer product list."""
    mock_products_by_site = {
        "ebuyer": [],
        "overclockers": [[2, "https://www.overclockers.co.uk/product/2"]],
    }
...
def test_lambda_handler_missing_ebuyer_site():
    """Test that lambda_handler handles missing ebuyer site gracefully."""
    mock_products_by_site = {
        "awd-it": [[1, "https://www.awd-it.co.uk/product/1"]],
    }
...
def test_lambda_handler_multiple_ebuyer_products():
    """Test that lambda_handler processes multiple ebuyer products."""
    mock_products_by_site = {
        "ebuyer": [
            [1, "https://www.ebuyer.com/product/1"],
            [2, "https://www.ebuyer.com/product/2"],
        ],
    }
    ...
    mock_scraped = [
        ...
        {
            "product_id": 2,
            "url": "https://www.ebuyer.com/product/2",
            "current_price": "£200",
            "currency_code": "GBP",
            "page_exists": True,
            "scraped_at": "2024-01-01T00:00:00"
